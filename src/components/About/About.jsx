...
export default function About() {
    return (
        <section className={`${st.about} section`} id="about">
            <h2 className={`section__title`}>Обо мне</h2>
            <span className={`section__subtitle`}>Введение</span>

            <div className={`${st.about__container} container grid`}>
                <img src={avatar} className={`${st.about__img}`} />

                <div className={`${st.about__data}`}>
                    <Info />

                    <p className={`${st.about__description}`}>
                        Создаю веб приложения, верстаю адаптивные сайты. Мой
